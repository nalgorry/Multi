...
var cControlPlayer = (function (_super) {
    ...
    cControlPlayer.prototype.showMessage = function (message) {
        var completeText = this.controlGame.game.add.sprite(15, -30);
        var text = this.controlGame.game.add.bitmapText(0, 0, 'gotic', message, 14);
    ...
    cControlPlayer.prototype.removeTweenText = function (sprite) {
        sprite.destroy();
    };
