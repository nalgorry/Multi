...
var cControlFocus = (function () {
    ...
    cControlFocus.prototype.showPlayerStats = function () {
        ...
        value.setTextBounds(0, 0, textWidth);
        backGroundDesc.addChild(value);
        var value = this.controlGame.game.add.text(textStart, heightStart + colHeight, this.getItemValue(0 /* speedLife */) + "%", styleText);
        value.setTextBounds(0, 0, textWidth);
        backGroundDesc.addChild(value);
        var value = this.controlGame.game.add.text(textStart + colWidth, heightStart + colHeight, this.getItemValue(1 /* speedMana */) + "%", styleText);
        value.setTextBounds(0, 0, textWidth);
        backGroundDesc.addChild(value);
        var value = this.controlGame.game.add.text(textStart + colWidth * 2, heightStart + colHeight, this.getItemValue(2 /* speedEnergy */) + "%", styleText);
        value.setTextBounds(0, 0, textWidth);
        backGroundDesc.addChild(value);
    };
