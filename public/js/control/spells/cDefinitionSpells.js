var cDefinitionSpells = (function () {
    ...
    cDefinitionSpells.prototype.definenumSpells = function () {
        ...
        var newSpell = new cSpell(this.controlGame);
        this.arraySpells[2 /* CriticalBallRelease */] = newSpell;
        newSpell.idSpell = 2 /* CriticalBallRelease */;
        ...
        newSpell.afterAnimationSpell = 10 /* CriticalBallHit */;
        //Special atack hit
        var newSpell = new cSpell(this.controlGame);
        this.arraySpells[10 /* CriticalBallHit */] = newSpell;
        newSpell.idSpell = 10 /* CriticalBallHit */;
